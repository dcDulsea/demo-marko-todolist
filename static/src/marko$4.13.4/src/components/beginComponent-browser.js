$_mod.def("/marko$4.13.4/src/components/beginComponent-browser", function(require, exports, module, __filename, __dirname) { var ComponentDef = require('/marko$4.13.4/src/components/ComponentDef'/*"./ComponentDef"*/);
