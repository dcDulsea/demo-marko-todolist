$_mod.def("/marko$4.13.4/src/runtime/helpers", function(require, exports, module, __filename, __dirname) { "use strict";
var removeDashes = require('/marko$4.13.4/src/compiler/util/removeDashes'/*"../compiler/util/removeDashes"*/);
var ComponentsContext = require('/marko$4.13.4/src/components/ComponentsContext'/*"../components/ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var ComponentDef = require('/marko$4.13.4/src/components/ComponentDef'/*"../components/ComponentDef"*/);
